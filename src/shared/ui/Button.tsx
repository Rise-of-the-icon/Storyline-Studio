...
export function Button({
  ...
  return (
    <button
      type={type}
      className={[
        "inline-flex cursor-pointer items-center justify-center rounded-md font-body font-medium transition-[background-color,border-color,color,box-shadow,transform] duration-150",
        ...
        "active:translate-y-px active:shadow-inner motion-reduce:active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-50 disabled:active:translate-y-0 disabled:active:shadow-none",
