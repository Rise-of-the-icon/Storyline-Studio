...
import { deriveStepperItems, type StepperItem } from "../lib/stepperState";
...
export function WizardStepper({
  ...
  return (
    <nav aria-label="Wizard progress" className="-mx-1">
      <ol
        className="flex items-center gap-1 overflow-x-auto px-1 pb-1 sm:flex-wrap sm:overflow-visible sm:gap-2 sm:pb-0"
...
function StepperChip({ item, onSelect, ref }: StepperChipProps) {
  ...
  return (
    ...
    >
      ...
      <span
        className={[
          "whitespace-nowrap font-mono text-[10px] uppercase tracking-wider sm:text-[11px]",
          labelClass,
        ].join(" ")}
        aria-hidden="true"
      >
