...
export const TOM_VOICE_SCRIPT_OPTIONS: VoiceScriptOption[] = [
  {
    ...
    sourceNote: "Wikipedia grounded; BDL verification pending",
    answerScript:
      "I came out of Washington, D.C., played at Villanova, and then made my way through a pro basketball world that asked you to prove yourself every night. I was a forward and center, and I spent time with the New York Knicks and the St. Louis Hawks before moving into the ABA with teams like Denver, Houston, Minnesota, and the New York Nets. My path was not a straight line, but it taught me how to stay ready, stay physical, and keep finding a role.",
  },
  {
    id: "tom-player-identity",
    question: "What kind of player were you on the floor?",
    sourceNote: "Wikipedia stats; BDL verification pending",
    answerScript:
  ...
  },
  {
    ...
    sourceNote: "Wikipedia grounded; BDL not applicable/pending",
    answerScript:
