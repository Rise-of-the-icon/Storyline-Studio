...
export function GuardrailWarningDetailModal({
  ...
  return (
    ...
    >
        ...
        <section className="mt-4" aria-labelledby="active-warnings">
          ...
          <ul className="mt-2 space-y-2">
            {resolverWarnings.map((warning) => (
              <li
                key={warning}
                className="rounded-md border border-gold/40 bg-goldfaint px-3 py-2 font-body text-sm text-text"
              >
                {warning}
              </li>
            ))}
      ...
      <p className="mt-4 meta-mono text-textmuted">
